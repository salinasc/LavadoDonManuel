"""
Django settings for myProyectoManuel project.
...
SECRET_KEY = 'q2$ba%o3@bih9)h06&59txvzalz^u05kherc-4)=akb5z7_@+c'
...
WSGI_APPLICATION = 'myProyectoManuel.wsgi.application'
